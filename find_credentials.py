...
def get_account(bundle_id):
    ...
    output = os.popen('security find-generic-password -j org.javawithravi.alfred.workflow.cisco.anytimeconnect.vip -g').read()
...
def get_password(bundle_id):
    ...
    output = os.popen('security find-generic-password -j org.javawithravi.alfred.workflow.cisco.anytimeconnect.vip -w').read()
